...
use Marvel\Http\Controllers\DeliveryController;
...
Route::get('/deliveries','Marvel\Http\Controllers\TagController@index'
);
Route::get('/deliveries','Marvel\Http\Controllers\OrderController@getDeliveries'
);
